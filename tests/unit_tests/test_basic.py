...
def test_package_imports() -> None:
    ...
    assert pygooglecloud.__name__ == "pygooglecloud"


def test_all_modules_import() -> None:
    """Every module in the package imports without errors."""
    for info in pkgutil.walk_packages(pygooglecloud.__path__, prefix="pygooglecloud.", onerror=_raise_on_package_error):
